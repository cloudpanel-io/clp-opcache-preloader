...
$magentoAutoloadFile = sprintf('%s/app/autoload.php', \rtrim(__DIR__, '/'));
require $magentoAutoloadFile;

$clpPreloader = new ClpPreloader();
$clpPreloader->setDebug(false);
$clpPreloader->paths(realpath(__DIR__ . '/app'));
$clpPreloader->paths(realpath(__DIR__ . '/generated'));
$clpPreloader->ignore(realpath(__DIR__ . '/vendor/magento/magento2-base/dev'));
